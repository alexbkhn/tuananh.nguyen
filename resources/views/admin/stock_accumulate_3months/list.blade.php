...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CP tích lũy 3M <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#infoModal" style="margin-left: 10px;"><i class="fas fa-info-circle"></i></button></h1>
          </div>
        </div>
      </div>
    </section>
...
$(document).ready(function() {
    ...
    function loadCharts(stockCode) {
        $.ajax({
            url: '{{ url("admin/stock_accumulate_3months/data") }}/' + stockCode,
            type: 'GET',
            dataType: 'json',
    ...
    $('#exportBtn').on('click', function() {
        ...
        link.setAttribute('download', 'CP_tich_luy_3M_' + new Date().getTime() + '.csv');
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6 class="mb-3"><strong>Tính năng: CP tích lũy 3M</strong></h6>
        <p>Danh sách này hiển thị các mã chứng khoán có biên độ giá (giá cao nhất - giá thấp nhất) trong 3 tháng gần nhất không quá 10%.</p>
        
        <h6 class="mb-2"><strong>Điều kiện lọc:</strong></h6>
        <ul>
          <li><strong>Biên độ giá:</strong> (Giá cao nhất - Giá thấp nhất) / Giá cao nhất ≤ 10% trong 3 tháng gần nhất</li>
          <li><strong>Số ngày giao dịch:</strong> Ít nhất 30 ngày giao dịch trong 3 tháng</li>
          <li><strong>Thời gian:</strong> Dữ liệu trong 3 tháng gần nhất</li>
        </ul>
