...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CP tăng giá nền <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#infoModal" style="margin-left: 10px;"><i class="fas fa-info-circle"></i></button></h1>
          </div>
        </div>
      </div>
    </section>
...
$(document).ready(function() {
    ...
    function loadCharts(stockCode) {
        $.ajax({
            url: '{{ url("admin/stock_base_high_increase/data") }}/' + stockCode,
            type: 'GET',
            dataType: 'json',
    ...
    $('#exportBtn').on('click', function() {
        ...
        link.setAttribute('download', 'CP_base_high_increase_' + new Date().getTime() + '.csv');
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6 class="mb-3"><strong>Tính năng: CP tăng giá nền</strong></h6>
        <p>Danh sách này hiển thị các mã chứng khoán có giá cao (price_high) trong phiên gần nhất cao hơn mức giá nền (trung bình price_high của 5 phiên trước đó).</p>
        
        <h6 class="mb-2"><strong>Điều kiện lọc:</strong></h6>
        <ul>
          <li><strong>Giá cao hiện tại lớn hơn giá nền:</strong> Giá cao nhất của phiên gần nhất phải lớn hơn trung bình giá cao nhất của 5 phiên trước đó</li>
          <li><strong>Dữ liệu:</strong> Sử dụng 6 phiên gần nhất (phiên hiện tại + 5 phiên trước)</li>
        ...
        <h6 class="mb-2"><strong>Vu khuyên:</strong></h6>
        <ul>
          <li>Tính năng này giúp xác định các mã chứng khoán có xu hướng tăng giá vượt qua mức giá nền</li>
          <li>Kết hợp với các yếu tố khác để đưa ra quyết định giao dịch</li>
        </ul>
      </div>
