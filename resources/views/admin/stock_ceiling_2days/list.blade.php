...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CP tăng trần 2 ngày liên tiếp gần nhất
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="font-size:0.9em;">
        ...
        - đều tăng trần (close = high = open = low) và phiên sau có giá đóng tăng so với phiên trước.<br>
...
$(document).ready(function() {
    ...
    $('#exportBtn').on('click', function() {
        ...
        link.setAttribute('download', 'CP_tang_tran_2d_' + now + '.csv');
