...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CP trần 3 ngày liên tiếp <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#infoModal" style="margin-left: 10px;"><i class="fas fa-info-circle"></i></button></h1>
          </div>
        </div>
      </div>
    </section>
...
$(document).ready(function() {
    ...
    function loadCharts(stockCode) {
        $.ajax({
            url: '{{ url("admin/stock_ceiling_3days/data") }}/' + stockCode,
            type: 'GET',
            dataType: 'json',
    ...
    $('#exportBtn').on('click', function() {
        ...
        link.setAttribute('download', 'CP_ceiling_3d_' + new Date().getTime() + '.csv');
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6 class="mb-3"><strong>Tính năng: CP trần 3 ngày liên tiếp mới nhất</strong></h6>
        <p>Danh sách này hiển thị các mã chứng khoán có nến trần trong 3 ngày liên tiếp, được lọc từ dữ liệu 4 ngày gần nhất.</p>
        
        <h6 class="mb-2"><strong>Điều kiện lọc:</strong></h6>
        <ul>
          <li><strong>Nến trần 3 ngày liên tiếp:</strong> Giá đóng cửa = giá cao nhất trong 3 ngày liên tiếp</li>
          <li><strong>Giá đóng cửa tăng:</strong> Giá đóng cửa của 3 ngày phải tăng liên tiếp (ngày 2 > ngày 1, và ngày 3 > ngày 2)</li>
          <li><strong>Khối lượng giao dịch:</strong> Khối lượng phải > 1000 cho cả 3 ngày</li>
