...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cây nến cao nhất 2 ngày - 90 ngày gần nhất <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#infoModal" style="margin-left: 10px;"><i class="fas fa-info-circle"></i></button></h1>
          </div>
        </div>
      </div>
    </section>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6 class="mb-3"><strong>Tính năng: Cây nến cao nhất 2 ngày - 90 ngày gần nhất</strong></h6>
