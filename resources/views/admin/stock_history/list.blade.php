...
-->
                  ...
                  <div class="col-sm-1">
                      <input type="int" class="form-control" id="stock_volume" name="stock_volume" required
                          placeholder="Số lượng">
                  </div>
                  <div class="col-sm-1">
                      <input type="float" class="form-control" id="stock_price" name="stock_price" required
                          placeholder="Giá">
                  </div>                                
                  <div class="col-sm-2 mb-3 mb-sm-0">
                  <!--
                  ...
                  -->
                    ...
                    <button class="btn btn-primary">Tạo mới</button> <!--style="margin-left: 150px;".._
              </div>
              </form>
            </div>
            <!-- /.card -->
