...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mã chứng khoán tăng 3 ngày liên tiếp - 10 ngày gần nhất <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#infoModal" style="margin-left: 10px;"><i class="fas fa-info-circle"></i></button></h1>
          </div>
        </div>
      </div>
    </section>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6 class="mb-3"><strong>Tính năng: Mã chứng khoán tăng 3 ngày liên tiếp - 10 ngày gần nhất</strong></h6>
        <p>Danh sách này hiển thị các mã chứng khoán có giá đóng cửa tăng liên tiếp trong 3 ngày, được lọc từ dữ liệu 3 ngày gần nhất.</p>
        
        <h6 class="mb-2"><strong>Điều kiện lọc:</strong></h6>
        <ul>
          <li><strong>Giá đóng cửa tăng 3 ngày liên tiếp:</strong> Giá đóng cửa phải tăng liên tục trong 3 ngày liên tiếp</li>
