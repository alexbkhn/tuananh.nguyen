...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CP tăng vsa 1vs3d <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#infoModal" style="margin-left: 10px;"><i class="fas fa-info-circle"></i></button></h1>
          </div>
        </div>
      </div>
    </section>
...
$(document).ready(function() {
    ...
    function loadCharts(stockCode) {
        $.ajax({
            url: '{{ url("admin/stock_vsa_volume_1vs3d/data") }}/' + stockCode,
            type: 'GET',
            dataType: 'json',
    ...
    $('#exportBtn').on('click', function() {
        ...
        link.setAttribute('download', 'CP_vsa_1vs3d_' + new Date().getTime() + '.csv');
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6 class="mb-3"><strong>Tính năng: CP tăng vsa 1vs3d (Volume Spike Alert - 1 vs 3 days)</strong></h6>
        <p>Danh sách này hiển thị các mã chứng khoán có tín hiệu tương quan khối lượng và giá, được lọc từ dữ liệu 3 ngày gần nhất.</p>
        
        <h6 class="mb-2"><strong>Điều kiện lọc:</strong></h6>
        <ul>
          <li><strong>Giá tăng với trần:</strong> Giá đóng cửa của ngày mới nhất cao hơn ngày cách 3 ngày trước AND giá đóng cửa = giá cao nhất (nến trần)</li>
          <li><strong>Khối lượng tăng đột biến:</strong> Khối lượng của ngày mới nhất tăng gấp >= 2 lần so với trung bình khối lượng 3 ngày trước đó</li>
